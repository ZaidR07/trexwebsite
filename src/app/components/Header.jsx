...
const Header = () => {
  return (
    <div className="z-[100] w-full fixed top-0 p-4 flex justify-between items-center bg-[#162038] h-[12vh] lg:h-[14vh]
                    bg-[rgba(255, 255, 255, 0.1)] backdrop-blur-lg border-b border-[rgba(255,255,255,0.2)] 
                    shadow-[0px_4px_10px_rgba(0,0,0,0.2)]">
      <div className="min-w-[20vw]">
        <span className="text-cyan-500 text-3xl block font-semibold">T-rex</span>
        <span className="text-gray-300 text-md -mt-4 ml-1">Infotech</span>
      </div>

      <svg xmlns="http://www.w3.org/2000/svg" fill="#06B5D2" width={25} viewBox="0 0 448 512">
